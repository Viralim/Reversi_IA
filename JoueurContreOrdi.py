...
import random
from IAContreIA import alpha_beta
...
def main():
    ...
    while not board.is_game_over():
        ...
        if board._nextPlayer == board._BLACK:
            ...
            #alpha_beta joue contre le joueur humain
            moves = all_possible_moves(board, depth=4, alpha=-float('inf'), beta=float('inf'), maximizing_player=True)
            move = moves[1]
